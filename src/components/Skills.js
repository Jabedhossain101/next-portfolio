  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] md:tracking-[0.3em] text-slate-400 group-hover:text-white transition-colors text-center">
          {skill.name}
        </span>
      </div>
    </motion.div>
...
const Skills = () => {
  return (
    <section
      className="relative min-h-screen py-20 md:py-32 bg-[#050505] overflow-hidden"
      id="skills"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-12 gap-8 mb-16 md:mb-24 items-end">
          <div className="lg:col-span-8">
            <div className="flex items-center gap-3 mb-4 md:mb-6">
              ...
              <span className="text-violet-400 text-[9px] md:text-[10px] font-black uppercase tracking-[0.4em]">
                Stack // Technologies
              </span>
            </div>
            <h2 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black text-white leading-[0.9] md:leading-[0.85] tracking-tighter uppercase">
              TECHNICAL <br />
          ...
          <div className="lg:col-span-4 pb-2 md:pb-4">
            <p className="text-slate-500 text-xs md:text-sm leading-relaxed uppercase tracking-widest border-l border-slate-800 pl-4 md:pl-6 font-light max-w-sm">
        ...
        <div className="space-y-20 md:space-y-32">
          {Object.entries(categories).map(([title, content], idx) => (
            ...
            >
              <div className="flex items-center justify-between mb-8 md:mb-12 group">
                <div className="flex items-center gap-4 md:gap-6">
                  <span className="text-2xl md:text-4xl font-mono text-white/20 group-hover:text-violet-500/40 transition-colors font-black leading-none">
                    {content.num}
                  </span>
                ...
                <div className="hidden md:block h-[1px] flex-grow mx-8 lg:mx-12 bg-slate-900" />
